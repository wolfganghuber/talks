---
title: 'Analysis of variance, regression and testing'
...
![](img/2025-HypothesisTesting-Huber_1.png)

# Examples: 
Testing efficacy of a drug on people
not an experiment — no complete control
finite sample size
Prioritising the results from a biological high-throughput experiment (e.g. RNA-seq differential expression; CRISPR screen)
….

+:  No understanding of mechanism involved / needed / desired
-:   Wouldn't we want to use any available understanding or ‘priors'?

<span style="color:#ffffff">Any fool can work with infinite data\.</span>

<span style="color:#ffffff">Statisticians do finity\.</span>

# Fundamental tradeoffs in statistical decision making

<span style="color:#000000">←bias                             accuracy→</span>
...
<span style="color:#000000">← precision            dispersion→ </span>
...
# Comparing a univariate (∈ℝ) measurement betweentwo groups:		the t-statistic
